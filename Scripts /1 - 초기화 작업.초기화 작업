...
CREATE TABLE erp.title (
	code INT(4)      NOT NULL COMMENT '직책 코드', -- 직책 코드
...
CREATE TABLE erp.department (
	code  INT(4)      NOT NULL COMMENT '부서 코드', -- 부서 코드
...
CREATE TABLE erp.employee (
	emp_no   INT(4)      NOT NULL COMMENT '사원 코드', -- 사원 코드
	emp_name VARCHAR(50) NULL     COMMENT '사원명', -- 사원명
	title    INT(4)      NULL     COMMENT '직책', -- 직책
	manager  INT(4)      NULL     COMMENT '직속 상사', -- 직속 상사
